In lesson [11.3 -- Arrays and loops](https://www.learncpp.com/cpp-tutorial/arrays-and-loops/), we showed examples where we used a *for loop* to iterate through each element of an array.
